  ...
  return (
    ...
    >
      <Image
        ...
        width={1920}
        height={1080}
        className="xl:row-span- rounded-2xl object-cover transition-transform duration-300 ease-in-out group-hover:scale-105 lg:col-span-7 lg:col-start-4 2xl:col-start-5"
      />
      ...
      <p className="mt-2 flex flex-col gap-2 text-pretty lg:col-span-5 lg:col-start-8 lg:row-start-2 lg:mt-0 xl:col-span-4 xl:col-start-9 xl:row-start-3 xl:text-xl">
        {children}
        {children && (
          <>
            <br />
